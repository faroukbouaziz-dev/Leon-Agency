  ...
  return (
    <section className="section section-m section-p">
      ...
      <div className="relative">
        <AboutArrow className="h-[380px] w-full sm:h-[450px] lg:h-[500px] xl:h-[550px]" />
        ...
        <p className="text-big lef-0 xs:w-[220px] top-full w-[180px] sm:w-[300px] lg:w-[350px] xl:w-[450] 2xl:w-[700px]">
